...
void menu(){
   ...
   // printf("________________________________________________________________________________________________________________________________________________________________________");
    ...
    printf("\n\n\n\n\t\t\t\t\t\t\t\t   CHOOSE ANY OF THE THREE OPTIONS!!\n\n");
		...
		printf("\n\t\t\t\t\t\t\t\t       *     3- Search a Student  		   *");
		printf("\n\t\t\t\t\t\t\t\t       *                      			   *");
		printf("\n\t\t\t\t\t\t\t\t       *     4- Sort all Student Records     *");
		printf("\n\t\t\t\t\t\t\t\t       *                      			   *");
		printf("\n\t\t\t\t\t\t\t\t       *     3- Modify a Student Record      *");
		printf("\n\t\t\t\t\t\t\t\t       *                      			   *");
		printf("\n\t\t\t\t\t\t\t\t       *     5- Delete a Student Record      *");
		printf("\n\t\t\t\t\t\t\t\t       *                     			       *");
	//	printf("\n\t\t\t\t\t\t\t\t       *     6- Display all Point Details    *");
	//	printf("\n\t\t\t\t\t\t\t\t       *                      			   *");
		printf("\n\t\t\t\t\t\t\t\t       *     0- Exit						   *");
		printf("\n\t\t\t\t\t\t\t\t       *                      			   *");	
		printf("\n\t\t\t\t\t\t\t\t       ***************************************");
...
void regist(FILE * fp){
	...
	if(fp==NULL){
        ...
        default:
      	...
      	printf("\n\t\tSelect your desired Route # according to the nearest stop to your home: ");
		printf("\n\t\tYour email is: \n");
...
void password(FILE *fp){
        int num=0,spec=0,uppercase=0,small=0;
		int j;		
        ...
        if(num<1 || spec<1 || uppercase<1 || small<1){
        	printf("\n\t\t\tInvalid Password!\n\n");
        	Beep(500,300);
...
void login_admin(){
    ...
    gets(user_pass);
    	while (1){
        if (strcmp("admin",user)==0 && strcmp("admin123",user_pass)==0){
				success = 1;
				break;
				}
		else{
...
int choice;
	system("cls");
				...
				sleep(1);
				printf("--------------------------------------------------------------------------\n");
//				printf("\n\t\t\t\t\t\t\t\t Press 1.Access information card");
